            ...
            <div class="card ">
                <div class="card-header bg-info">
                    ...
                    <div class="form-body">
                        ...
                        <div class="card-body">
                            <form id="addArtikel" action="{{route('artikel.store')}}" method="POST" class="form-horizontal">
                                @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="titles" class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="title" class="form-control" placeholder="Masukkan judul artikel" name="title"><small id="pesan-title" class="pesan form-control-feedback">Masukan salah</small></div>
                                    </div>
                                </div>
                            </div>

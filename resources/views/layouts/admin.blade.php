                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu mailbox dropdown-menu-right scale-up">
                                <ul class="dropdown-user list-style-none">
                                        ...
                                        <div class="dw-user-box p-3 d-flex">
                                            <div class="u-img">
                                                @if ($admin->profile_image)
                                                    <img src="{{asset($admin->profile_image)}}" alt="user" class="rounded" width="80">
                                                @else
                                                    <img src="{{asset('/assets/admin/src/assets/images/users/1.jpg')}}" alt="user" class="rounded" width="80">
                                                @endif
                                            </div>
                                            <div class="u-text ml-2">
                                                <h4 class="mb-0">{{$admin->name}}</h4>
                                                <p class="text-muted mb-1 font-14">{{$admin->email}}</p>
                                    ...
                                    @if ($admin->is_super == 1)
                                        <li class="user-list"><a class="px-3 py-2" href="{{route('register.admin')}}"><i class="fas fa-sign-in-alt"></i> Register Admin</a></li>
                                        <li class="user-list"><a class="px-3 py-2" href="#"><i class="ti-user"></i> Admin</a></li>
                                    @endif
                                    <li role="separator" class="dropdown-divider"></li>
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile position-relative" style="background: url({{asset('/assets/admin/src/assets/images/background/new-bg.jpg')}}) no-repeat;">
                    ...
                    <div class="profile-text pt-1"> 
                        <a class="w-100 text-white d-block position-relative">{{Auth::guard('admin')->user()->name}}</a>
                    </div>
                </div>

    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{asset('/assets/admin/src/assets/images/logo-icon.png')}}" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="{{asset('/assets/admin/src/assets/images/logo-icon.png')}}" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                            ...
                            <!-- Light Logo text -->
                            <img src="{{asset('/assets/admin/src/assets/images/logo-light-text.png')}}" class="light-logo" alt="homepage" />
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid"
                                                            src="{{asset('/assets/admin/src/assets/images/big/img1.jpg')}}" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid"
                                                            src="{{asset('/assets/admin/src/assets/images/big/img2.jpg')}}" alt="Second slide">
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid"
                                                            src="{{asset('/assets/admin/src/assets/images/big/img3.jpg')}}" alt="Third slide"></div>
                                                </div>
                                            </div>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                <!-- User profile -->
                <div class="user-profile position-relative" style="background: url({{asset('/assets/admin/src/assets/images/background/user-info.jpg')}}) no-repeat;">
                    <!-- User profile image -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card blog-widget">
                            <div class="card-body">
                                <div class="blog-image"><img src="{{asset('/assets/admin/src/assets/images/big/img1.jpg')}}" alt="img"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <img class="rounded-top" src="{{asset('/assets/admin/src/assets/images/background/weatherbg.jpg')}}"
                                alt="Card image cap">
                    ...
                    <div class="col-lg-4 col-md-12">
                        ...
                        <div class="card">
                            <img class="card-img-top w-100 profile-bg-height"
                                src="{{asset('/assets/admin/src/assets/images/background/profile-bg.jpg')}}" alt="Card image cap">
                            <div class="card-body little-profile text-center">
                                <div class="pro-img"><img src="{{asset('/assets/admin/src/assets/images/users/4.jpg')}}" alt="user"
                                    ...
                                    <div class="message-widget contact-widget position-relative">
                                        ...
                                        <a href="#" class="py-3 px-2 border-bottom d-flex align-items-center text-decoration-none">
                                            <div class="user-img position-relative d-inline-block mr-2"> <img
                                                    src="{{asset('/assets/admin/src/assets/images/users/1.jpg')}}" alt="user"
                                        ...
                                        <a href="#" class="py-3 px-2 border-bottom d-flex align-items-center text-decoration-none">
                                            <div class="user-img position-relative d-inline-block mr-2"> <img
                                                    src="{{asset('/assets/admin/src/assets/images/users/2.jpg')}}" alt="user"
                                                    class="rounded-circle w-100">
                                                <span
                                        ...
                                        <a href="#" class="py-3 px-2 d-flex align-items-center text-decoration-none">
                                            <div class="user-img position-relative d-inline-block mr-2"> <img
                                                    src="{{asset('/assets/admin/src/assets/images/users/4.jpg')}}" alt="user"
                                                    class="rounded-circle w-100">
                                                <span
                                                    class="profile-status pull-right d-inline-block position-absolute bg-warning rounded-circle"></span>
                                            </div>
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="card-body">
                                        <div class="profiletimeline position-relative">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                    src="{{asset('/assets/admin/src/assets/images/big/img1.jpg')}}" alt="user"
                                                                    class="img-fluid rounded"></div>
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                    src="{{asset('/assets/admin/src/assets/images/big/img2.jpg')}}" alt="user"
                                                                    class="img-fluid rounded"></div>
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                    src="{{asset('/assets/admin/src/assets/images/big/img3.jpg')}}" alt="user"
                                                                    class="img-fluid rounded"></div>
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                    src="{{asset('/assets/admin/src/assets/images/big/img4.jpg')}}" alt="user"
                                                                    class="img-fluid rounded"></div>
                                                        </div>
                                            ...
                                            <div class="sl-item mt-2 mb-3">
                                                <div class="sl-left float-left mr-3"> <img
                                                        src="{{asset('/assets/admin/src/assets/images/users/3.jpg')}}" alt="user"
                                                        class="rounded-circle"> </div>
                                                <div class="sl-right">
                                                    <div>
                                                        <div class="d-md-flex">
                        ...
                        <li>
                            <div class="message-center chat-scroll position-relative">
                                ...
                                <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2" id='chat_user_5' data-user-id='5'>
                                    <span  class="user-img position-relative d-inline-block"> <img src="{{asset('/assets/admin/src/assets/images/users/5.jpg')}}" alt="user" class="rounded-circle w-100"> <span class="profile-status rounded-circle offline"></span> </span>
                                    <div class="w-75 d-inline-block v-middle pl-2">
                                ...
                                <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2" id='chat_user_6' data-user-id='6'>
                                    <span  class="user-img position-relative d-inline-block"> <img src="{{asset('/assets/admin/src/assets/images/users/6.jpg')}}" alt="user" class="rounded-circle w-100"> <span class="profile-status rounded-circle offline"></span> </span>
                                    <div class="w-75 d-inline-block v-middle pl-2">
                                ...
                                <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2" id='chat_user_7' data-user-id='7'>
                                    <span  class="user-img position-relative d-inline-block"> <img src="{{asset('/assets/admin/src/assets/images/users/7.jpg')}}" alt="user" class="rounded-circle w-100"> <span class="profile-status rounded-circle offline"></span> </span>
                                    <div class="w-75 d-inline-block v-middle pl-2">
                                        <h5 class="message-title mb-0 mt-1">Pavan kumar</h5> <span class="font-12 text-nowrap d-block text-muted text-truncate">Just see the my admin!</span> <span class="font-12 text-nowrap d-block text-muted">9:02 AM</span> </div>
                                </a>
                                <!-- Message -->
                                ...
                                <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2" id='chat_user_8' data-user-id='8'>
                                    <span  class="user-img position-relative d-inline-block"> <img src="{{asset('/assets/admin/src/assets/images/users/8.jpg')}}" alt="user" class="rounded-circle w-100"> <span class="profile-status rounded-circle offline"></span> </span>
                                    <div class="w-75 d-inline-block v-middle pl-2">
                    ...
                    <div class="steamline">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user"
                                    src="{{asset('/assets/admin/src/assets/images/users/2.jpg')}}"> </div>
                            <div class="sl-right">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user"
                                    src="{{asset('/assets/admin/src/assets/images/users/1.jpg')}}"> </div>
                            <div class="sl-right">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user"
                                    src="{{asset('/assets/admin/src/assets/images/users/4.jpg')}}"> </div>
                            <div class="sl-right">
                                <div class="font-medium">Go to the Doctor <span class="sl-date">5 minutes ago</span>
                                </div>
                                <div class="desc">Contrary to popular belief</div>
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user"
                                    src="{{asset('/assets/admin/src/assets/images/users/6.jpg')}}"> </div>
                            <div class="sl-right">
                                <div><a href="javascript:void(0)">Stephen</a> <span class="sl-date">5 minutes ago</span>
                                </div>
                                <div class="desc">Approve meeting with tiger</div>
